...
def main(page: ft.Page):
    ...
    lista_alumnos = ft.Dropdown(
        ...
        label="Alumnos",
        options=[
            ft.dropdown.Option("Gerardo Díaz el Cubito Saltarin"),
            ft.dropdown.Option("Ismael Macias Pérez"),
            ft.dropdown.Option("Uziel Tupak Flores Marchan"),
            ft.dropdown.Option("Erwin Peña Martinez"),
    ...
    def obtener_color(promedio):
        if promedio < 60:
            ...
            return ft.Container(width=20, height=20, bgcolor="green", border_radius=50)
    ...
    boton_borrar = ft.ElevatedButton(text="Borrar Alumno", color="white", bgcolor="red", on_click=borrar_alumno)
    boton_borrar_todo = ft.ElevatedButton(text="Borrar Todo", color="white", bgcolor="black", on_click=borrar_todo)
    boton_exportar = ft.ElevatedButton(text="Exportar CSV", color="white", bgcolor="green", on_click=exportar_csv)
